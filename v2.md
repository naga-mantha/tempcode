...
- V2 scaffolding
  ...
  - PolicyService stub (permissive) with rollout mask flag `POLICY_ENFORCE_READ_MASK` in settings.
...
- Exemplar Table (Layouts)
  ...
  - Policy masking (flagged) in Serializer; row scoping via `policy.filter_queryset()`.
