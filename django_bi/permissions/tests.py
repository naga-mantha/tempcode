...
class RebuildFieldPermissionsCommandTests(TestCase):
    ...
    @patch(
        "django_bi.permissions.management.commands.rebuild_field_permissions.generate_field_permissions_for_model",
        return_value=(0, 0),
    )
...
class ProxyAndAbstractModelTests(TestCase):
    def test_returns_zero_for_proxy_model(self):
        ...
        with patch(
            "django_bi.permissions.utils.ContentType.objects.get_for_model"
