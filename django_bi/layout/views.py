...
from django_bi.layout.models import Layout, LayoutBlock, LayoutFilterConfig
...
from django_bi.layout.forms import (
    LayoutForm,
    AddBlockForm,
    LayoutFilterConfigForm,
)

from django_bi.layout.mixins import LayoutFilterSchemaMixin, LayoutAccessMixin
from django_bi.layout.helpers.json import parse_json_body
from django_bi.layout.helpers.formsets import get_layoutblock_formset
from django_bi.layout.helpers.filters import build_namespaced_get
...
class LayoutBlockRenderView(LoginRequiredMixin, LayoutAccessMixin, LayoutFilterSchemaMixin, View):
    ...
    def get(self, request, username, slug, id, *args, **kwargs):
        ...
        pref_name = (lb.preferred_filter_name or "").strip()
        if pref_name:
            from django_bi.blocks.models.block_filter_config import BlockFilterConfig as BFC
        ...
        pref_col = (lb.preferred_column_config_name or "").strip()
        if pref_col:
            from django_bi.blocks.models.block_column_config import BlockColumnConfig as BCC
