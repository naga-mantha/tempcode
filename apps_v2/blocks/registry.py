...
from apps_v2.blocks.options import ALLOWED_OPTIONS as TABLE_ALLOWED_OPTIONS
...
def _validate_spec(spec: BlockSpec) -> None:
    ...
    if spec.kind == "table":
        ...
        try:
            from apps_v2.blocks.services.model_table import ModelColumnResolver, ModelQueryBuilder
