...
from apps.django_bi.workflow.utils import generate_workflow_permissions_for_model


@receiver(post_migrate, dispatch_uid="apps.django_bi.workflow.generate_workflow_permissions")
