...
from apps.django_bi.blocks.views import table as table_views
from apps.django_bi.blocks.views import chart as chart_views
from apps.django_bi.blocks.views import pivot as pivot_views
